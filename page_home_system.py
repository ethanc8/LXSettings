    ...
    def __init__(self):
        ...
        self.items = [
            LXSettings.DirectoryButton(
                ...
                onclick = lambda _: [
                    LXSettings.open_process_sudo(["timeshift-launcher"])
                ]
            ), LXSettings.DirectoryButton(
                ...
                onclick = lambda _: [
                    LXSettings.open_process_sudo(["time-admin"])
                ]
            ), LXSettings.DirectoryButton(
                icon_name = "shares-admin",
                label_str = "Shared Folders",
                description_str = "Share folders with other users",
                onclick = lambda _: [
                    LXSettings.open_process_sudo(["shares-admin"])
                ]
            # ), LXSettings.DirectoryButton(
